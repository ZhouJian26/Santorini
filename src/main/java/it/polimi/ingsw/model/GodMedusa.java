                    ...
                    if (map[i][j].getBlock().equals(TypeBlock.WORKER) && !map[i][j].getBlock().getOwner().equals(godPower.getName())){
                        if(map[i][j].getSize()<map[position[0]][position[1]].getSize()){
                            ...
                            switch (map[i][j].getSize()){
                                case 0:map[i][j].addBlock(new Block(TypeBlock.LEVEL1));break;
                                case 1:map[i][j].addBlock(new Block(TypeBlock.LEVEL2));break;
                                case 2:map[i][j].addBlock(new Block(TypeBlock.LEVEL3));break;
                                default:break;
                            }
                        }
                    }
